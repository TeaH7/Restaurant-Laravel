  ...
  <main id="main">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="menu-flters">
              ...
              <li data-filter=".filter-{{$category->name}}">{{ ucwords($category->name) }}</li>
          ...
          @if ($products->count())
              ...
              <div class="col-lg-6 menu-item filter-{{$product->category->name}}">
                ...
                <div class="menu-content">
                  <a href="#">{{$product->name}}</a><span>{{round($product->price)}}Leke</span>
                </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $special->id == 2 ? 'active' : '' }}" data-bs-toggle="tab" href="#tab-{{$special->id}}">{{$special->name}}</a>
                </li>
            @endforeach
            </ul>
          </div>
          <div class="col-lg-9 mt-4 mt-lg-0">
              <div class="tab-content">
                @foreach ($specials as $special)
                <div class="tab-pane {{ $special->id == 2 ? 'active' : '' }}" id="tab-{{$special->id}}">
                  <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
                      <h3>{{$special->name}}</h3>
                      <p class="fst-italic">{{$special->ingredients}}</p>
                      <p>{{$special->description}}</p>
                    </div>
                    <div class="col-lg-4 text-center order-1 order-lg-2">
                      <img src="{{asset('storage/'.$special->image)}}" alt="" class="img-fluid">
                    </div>
                  </div>
                </div>
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form method="POST" action="{{route('admin-reservation-store')}}"  role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
            @csrf
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="number" class="form-control" name="nr_of_people" id="people" placeholder="# of people" data-rule="minlen:1" data-msg="Please enter at least 1 chars">
              <div class="validate"></div>
            </div>
          </div>
          ...
          <div class="swiper-wrapper">
           ...
           <div class="swiper-slide">
            <div class="testimonial-item">
              ...
              <h3>{{$testimonial->name}} {{$testimonial->lastname }}</h3>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form method="post" action="{{route('admin-contact-store')}}" role="form" class="php-email-form">
                @csrf
              <div class="row">
